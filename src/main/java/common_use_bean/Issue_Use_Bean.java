...
public class Issue_Use_Bean {
	...
	private String serial_id_no;
	private String issue_id_no;
	...
	public String getIssue_id_no() {
		return issue_id_no;
	}
	public void setIssue_id_no(String issue_id_no) {
		this.issue_id_no = issue_id_no;
	}
	...
	public String getSerial_id_no() {
		return serial_id_no;
	}
	public void setSerial_id_no(String serial_id_no) {
		this.serial_id_no = serial_id_no;
	}
