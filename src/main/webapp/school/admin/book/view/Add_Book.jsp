							...
							%>
                                            ...
                                            <section class="panel">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <form action="<%=Common_Things.url%>/admin-add-book-controller" class="form-horizontal" role="form" name="myForm"  onsubmit="return validateForm()">
                                                        ...
                                                        <hr> 
                                                         <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" placeholder="EAN Code" name="ean_code">
                                                            </div>
                                                        </div>
                                                        <hr> 
