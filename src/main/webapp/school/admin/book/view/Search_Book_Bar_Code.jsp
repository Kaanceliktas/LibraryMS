                            ...
                            <section class="panel">
                                ...
                                <ul class="list-group">
                                	...
                                	Librepository_Table_Model obj_Librepository_Table_Model=new Librepository_Table_Model();  
                       	                  	List<Book_Use_Bean> list_books=obj_Librepository_Table_Model.get_serial_from_bar_code(search);
                           	...
                           	%>
                                   			 ...
                                   			 <tr>
                                                <td><%=temp_count++ %></td>
                                                    <td>      	<a href="<%=Common_Things.url %>/complete-details-of-book/?s=<%=obj_Book_Use_Bean.getBook_id_no() %>"  class="btn btn-success btn-xs" ><%=obj_Book_Use_Bean.getBook_title() %></a></td>
