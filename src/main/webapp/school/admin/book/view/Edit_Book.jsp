            ...
            <section class="main-content">
                ...
                <div class="content-wrap">
                    ...
                    <div class="row mg-b">
                       ...
                       <a href="<%=Common_Things.url %>/complete-details-of-book/?s=<%=book_id_no %>" class="btn btn-info">Complete Details</a>
                                	...
                                	<%
                                	  ...
                                	  <li class="list-group-item">
                                        ...
                                        <div class="show no-margin pd-t-xs">
                                           	...
                                           	<a href="<%=Common_Things.url %>/complete-details-of-book/?s=<%=obj_Book_Use_Bean.getBook_id_no() %>"  class="btn btn-success btn-xs" ><%=obj_Book_Use_Bean.getBook_title() %></a>
                                        </div>
