...
<body>
    ...
    <div class="app" data-sidebar="locked">
        <!-- top header -->
			...
			<%
			String book_id_no=(String)request.getParameter("s");
            ...
            <section class="main-content">
                ...
                <div class="content-wrap">
                    ...
                    <div class="row mg-b">
                       ...
                       <a href="<%=Common_Things.url %>/librepository-books/?kou=<%=obj_Book_Use_Bean.getBook_id_no() %>" class="btn btn-info">Librepository</a>
