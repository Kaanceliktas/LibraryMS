...
<body>
    ...
    <div class="app" data-sidebar="locked">
        <!-- top header -->
			...
			<%
			String issue_id_no=(String)request.getParameter("lololo");
			Issue_Table_Model  obj_Issue_Table_Model=new Issue_Table_Model();
			
			Issue_Use_Bean obj_Issue_Use_Bean=obj_Issue_Table_Model.get_complete_details_of_issue(issue_id_no);
			%>
                                            ...
                                            <section class="panel">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <form action="<%=Common_Things.url%>/update-issue-book-contro/" class="form-horizontal" role="form" method="post" name="myForm"  onsubmit="return validateForm()">
                                                    	...
                                                    	<input type="hidden" name="book_id_no" value="<%=obj_Issue_Use_Bean.getBook_id_no() %>">
                                                    <input type="hidden" name="issue_id_no" value="<%=issue_id_no %>"> 
