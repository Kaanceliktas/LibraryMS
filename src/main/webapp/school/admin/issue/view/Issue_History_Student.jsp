        ...
        <!-- top header -->
            ...
            <section class="main-content">
                ...
                <div class="content-wrap">
                    ...
                    <div class="row mg-b">
                        <div class="col-xs-8"> 
                            <h3 class="no-margin">Issue History :<%=student_name %></h3>
                        ...
                        <div class="col-lg-12">
                            <section class="panel">
                           	...
                           	%>
                                               ...
                                               <td> 
                                               			 <a href="<%=Common_Things.url %>/issue-history/?jin=<%=obj_Issue_Use_Bean.getBook_title() %>&bn=<%=obj_Issue_Use_Bean.getBarcode() %>" class="btn btn-danger btn-xs"><%=obj_Issue_Use_Bean.getBarcode() %></a>
