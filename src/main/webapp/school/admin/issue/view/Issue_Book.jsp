...
<body>
    ...
    <div class="app" data-sidebar="locked">
        <!-- top header -->
			...
			<%
			String librepository_sl=(String)request.getParameter("jin");
			Librepository_Table_Model obj_Librepository_Table_Model=new Librepository_Table_Model();
			Book_Use_Bean obj_Book_Use_Bean=obj_Librepository_Table_Model.get_serial_status(librepository_sl);
							...
							%>
                                            ...
                                            <section class="panel">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <form action="<%=Common_Things.url%>/issue-book-contr/" class="form-horizontal" role="form" method="post" name="myForm"  onsubmit="return validateForm()">
                                                    
                                                    	<input type="hidden" name="book_id_no" value="<%=obj_Book_Use_Bean.getBook_id_no() %>">
                                                    <input type="hidden" name="serial_id_no" value="<%=librepository_sl %>"> 
                                                    
                                                        <div class="form-group">
                                                            <label for="inputEmail3" class="col-sm-2 control-label">Book Title </label>
                                                            	<div class="col-sm-10">
                                                               	<input type="text" class="form-control" name="book_title"  data-parsley-required="true" value="<%=obj_Book_Use_Bean.getBook_title() %>" data-parsley-trigger="change" placeholder="Book Title" readonly="readonly">
                                                               </div> 
                                                     ...
                                                     <hr> 
                                                         <div class="form-group">
                                                            <label for="inputEmail3" class="col-sm-2 control-label">Bar Code </label>
                                                            	<div class="col-sm-10">
                                                               	<input type="text" class="form-control" name="barcode"  data-parsley-required="true" value="<%=obj_Book_Use_Bean.getBar_code() %>" data-parsley-trigger="change" placeholder="Bar Code" readonly="readonly">
                                                               </div> 
                                                     ...
                                                     <hr> 
                                                         <div class="form-group">
                                                            <label for="inputEmail3" class="col-sm-2 control-label">Student Admission No* </label>
                                                            	<div class="col-sm-10">
                                                               	<input type="text" class="form-control" name="admission_no" id="search" data-parsley-required="true" data-parsley-trigger="change" placeholder="Student Admission No">
                                                               </div> 
