            ...
            <section class="main-content">
                ...
                <div class="content-wrap">
                    ...
                    <div class="row mg-b">
                       ...
                       <a href="<%=Common_Things.url %>/view-all-pending-issues/?kou=<%="232323243kihnadfhlacfhdkaudfhnakcdfchakdfhbkavhdfhna" %>" class="btn btn-info">View All Pending History</a>
                        ...
                        <div class="col-lg-12">
                            <section class="panel">
                           	...
                           	%>
                                               ...
                                               <td><a href="<%=Common_Things.url %>/update-issue-book/?lololo=<%=obj_Issue_Use_Bean.getIssue_id_no() %> " class="btn btn-success btn-xs">Update</a> </td> 
                       	                             	...
                       	                             	if(temp_count==101){  
                       	                                	%>
                       			                              ...
                       			                              <%
                       			                              					if(int_lim==1){
                       			                              %>
                       			            	          						 <a href="<%=Common_Things.url %>/complete-issue-history/?lim=<%=0 %>"  class="btn btn-danger btn-xs">Previous</a>
                       	                     											
                       			                              <%						
                       			                              					}else if(int_lim!=0){    
                       			                              %>
                       			            	          								<a href="<%=Common_Things.url %>/complete-issue-history/?lim=<%=int_lim-1 %>"  class="btn btn-danger btn-xs">Previous</a>
                       			                              ...
                       			                              %>  			
                       			                                			...
                       			                                			<td></td>
                       			                							<td>
                       			                                				   <a href="<%=Common_Things.url %>/complete-issue-history/?lim=<%=int_lim+1 %>"  class="btn btn-danger btn-xs">Next</a>
