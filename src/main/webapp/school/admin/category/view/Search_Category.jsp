                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <form action="<%=Common_Things.url%>/admin-search-category/" class="form-horizontal" role="form">
                                                        <div class="form-group">
                                                            <label for="inputEmail3" class="col-sm-2 control-label">Category </label>
                                                            	<div class="col-sm-10">
                                                               	<input type="text" class="form-control" name="search" data-parsley-required="true" data-parsley-trigger="change" placeholder="Category Search" value="<%if(search!=null){out.println(search);} %>">
                                                               </div> 
                            ...
                            <section class="panel">
                           	...
                           	%>
                                                ...
                                                <td><%if(obj_Category_Use_Bean.getProfile()!=null){out.println(obj_Category_Use_Bean.getProfile());} %></td>
                                               	<td><a href="<%=Common_Things.url %>/edit-category/?id_no=<%=obj_Category_Use_Bean.getSl_no() %>&n=<%=obj_Category_Use_Bean.getCategory_name() %>&d=<%=obj_Category_Use_Bean.getProfile() %>" class="btn btn-success btn-xs">Edit</a> </td>
                                            </tr>
