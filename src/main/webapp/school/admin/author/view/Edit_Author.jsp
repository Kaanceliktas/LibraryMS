        ...
        <!-- top header -->
            ...
            <section class="main-content">
                ...
                <div class="content-wrap">
                    ...
                    <div class="row mg-b">
                        <div class="col-xs-6"> 
                            <h3 class="no-margin">Edit Author</h3>
                    		...
                    		%>
                                            ...
                                            <section class="panel">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <form action="<%=Common_Things.url%>/edit-author-controller/" class="form-horizontal" role="form">
                                                       
                                                       <input type="hidden" name="id_no" value="<%=id_no %>">
                                                        <div class="form-group">
                                                            <label for="inputEmail3" class="col-sm-2 control-label">Author </label>
                                                            	<div class="col-sm-10">
                                                               	<input type="text" class="form-control" value="<%=author_name %>" name="author_name" data-parsley-required="true" data-parsley-trigger="change" placeholder="Category ">
                                                               </div> 
