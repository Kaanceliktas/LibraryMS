                            ...
                            <section class="panel">
                           	...
                           	%>
                                                ...
                                                <td><%if(obj_Author_Use_Bean.getProfile()!=null){out.println(obj_Author_Use_Bean.getProfile());} %></td>
                                               	<td><a href="<%=Common_Things.url  %>/edit-author/?id_no=<%=obj_Author_Use_Bean.getSl_no() %>&n=<%=obj_Author_Use_Bean.getAuthor_name() %>&d=<%=obj_Author_Use_Bean.getProfile() %>" class="btn btn-success btn-xs">Edit</a> </td>
                                            </tr>
