...
<%@page import="Librepository_Table_Model.Librepository_Table_Model"%>
        ...
        <!-- top header -->
            ...
            <section class="main-content">
                ...
                <div class="content-wrap">
					<%
					 String serial_id_no=(String)request.getParameter("s");
					...
					obj_Book_Use_Bean=obj_Librepository_Table_Model.get_serial_status(serial_id_no);
                    ...
                    <div class="row mg-b">
                        <div class="col-xs-8"> 
                           ...
                           <a href="<%=Common_Things.url %>/librepository-books/?kou=<%=obj_Book_Use_Bean.getBook_id_no() %>" class="btn btn-info">Back</a>
                        </h3>
                        </div>
                        <%
                    ...
                    <div class="col-lg-6">
                    		...
                    		<%
							String message=(String)session.getAttribute("edit_librepository_message");
							if(message!=null){
							%> 
							...
							<%	session.removeAttribute("edit_librepository_message");
							}
							%>
                                            ...
                                            <section class="panel">
                                                <header class="panel-heading">Edit Librepository</header>
                                                <div class="panel-body">
 
												<form action="<%=Common_Things.url%>/edit-librepository-serial-contro/" class="form-horizontal" role="form" name="myForm"  onsubmit="return validateForm()">
                                                       <input type="hidden" name="id_no" value="<%=serial_id_no %>">
