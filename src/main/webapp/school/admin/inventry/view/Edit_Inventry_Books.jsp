...
<%@page import="Librepository_Table_Model.Librepository_Table_Model"%><html class="no-js">
        ...
        <!-- top header -->
            ...
            <section class="main-content">
                ...
                <div class="content-wrap">
                    ...
                    <div class="row mg-b">
                        <div class="col-xs-6"> 
                            <h3 class="no-margin">Add Librepository</h3>
                            
                        </div>
                        <%
                        String book_id_no=(String)request.getParameter("kou");
						
                        %>
                       <a href="<%=Common_Things.url %>/complete-details-of-book/?s=<%=book_id_no %>" class="btn btn-info">Back</a>
                    ...
                    <div class="col-lg-6">
                    		...
                    		<%
							String message=(String)session.getAttribute("add_librepository_message");
							if(message!=null){
							%> 
							...
							<%			session.removeAttribute("add_librepository_message");
							}
							...
							obj_Book_Use_Bean=obj_Admin_Book_Table_Model.get_Complete_details_of_book(book_id_no);
							%>
                                            ...
                                            <section class="panel">
                                                <header class="panel-heading">Add Librepository</header>
                                                <div class="panel-body">
 
												<form action="<%=Common_Things.url%>/librepository-book-controller/" class="form-horizontal" role="form" name="myForm"  onsubmit="return validateForm()">
                                                       <input type="hidden" name="book_id_no" value="<%=book_id_no %>">
                                                       ...
                                                       %>
                                                          <input type="hidden" name="total_book_available" value="<%=obj_Librepository_Table_Model.get_count_serial_number(book_id_no)%>">
                    ...
                    <div class="col-lg-6">
                            <section class="panel">
                                ...
                                <div class="panel-heading">Librepository
                                ...
                                <ul class="list-group">
                                	...
                                	//Librepository_Table_Model obj_Librepository_Table_Model=new Librepository_Table_Model();  
                       	                  	List<Book_Use_Bean> list_librepository=obj_Librepository_Table_Model.get_librepository_of_books(book_id_no);
                       	                                	 
                       	                                	
                       	                                	if(list_librepository!=null){
                       	                                		Iterator<Book_Use_Bean> it_list_librepository=list_librepository.iterator();
                       	                                	int temp_count=1;
                       	                                		while(it_list_librepository.hasNext()){
                       	                                			obj_Book_Use_Bean=it_list_librepository.next();
                           	%>
                                               ...
                                               <td><a href="<%=Common_Things.url %>/edit-category/?id_no=<%=obj_Book_Use_Bean.getLibrepository_id_no() %>" class="btn btn-success btn-xs">Edit</a> </td>
                                            </tr>
                                	 ...
                                	 <table class="table table-hover no-margin">
                                        <thead>  
                                            ...
                                            <tr>		<form action="<%=Common_Things.url %>/print-bar-code/" target="_blank">
                                            				<input type="hidden" name="kou" value="<%=book_id_no %>">
                        ...
                        <div class="col-lg-12">
                            <section class="panel">
                                ...
                                <ul class="list-group">
                                	...
                                	<%
                               // 	Librepository_Table_Model obj_Librepository_Table_Model=new Librepository_Table_Model();                                                                                                                               		//Admin_Book_Table_Model obj_Admin_Book_Table_Model=new Admin_Book_Table_Model(); 
                             	List<Book_Use_Bean> list_books=obj_Librepository_Table_Model.get_books_status(book_id_no);
                             		...
                             		while(it_list_books.hasNext()){
                             			obj_Book_Use_Bean=it_list_books.next();
                                             ...
                                             <td>
                                               ...
                                               <td>
                                                <a href="<%=Common_Things.url %>/edit-librepository-serial/?s=<%=obj_Book_Use_Bean.getSl_no() %>" class="btn btn-danger btn-xs">Edit</a>
